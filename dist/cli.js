...
exports.ANDROID_DEFAULT_FLAVOR = 'main';
...
function generateNativeProjectConfig(platform, args) {
    ...
    const flavor = cli_1.getOptionValue(args, `--${platform}-flavor`, platform === "android" /* ANDROID */ ? exports.ANDROID_DEFAULT_FLAVOR : undefined);
